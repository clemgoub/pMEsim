...
parser.add_argument('-g', '--genome', type = str, metavar='STR', help='reference genomes (fa/fa.gz)', dest = 'ref_genome', default = 'GCA_000001405.15_GRCh38_no_alt_analysis_set.fasta.gz')
...
parser.add_argument('-f', '--target_fasta', type = str, metavar='STR', help='fasta file for the target chromosome', dest = 'target_fasta', default = 'hg38.chr22.fa')
parser.add_argument('-b', '--bed', type=str, metavar='STR', help='bed file with reference insertions to use', dest = 'bed_in', default = 'hg38.AluY.L1HSPA2.SVA_EF.bed')
...
# check input length to make sure we don't sample more than there is
...
for index, repeat in repmask_subset.iterrows():
    ...
    # else, we will do a random insertion
        ...
        while ref_sequence == 'N':
            ...
            ref_sequence = target_chrom_seq[rnd_pos - 1]
